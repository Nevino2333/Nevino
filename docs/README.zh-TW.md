...
🚀 快速指南：
[**🖥️線上預覽**](http://rainzt.cn/) /
[**📝使用文檔**](https://docs-rainzt.cn/) /
...
>
>**更多版面配置及示範請查看：[Firefly 版面配置系統詳解](http://rainzt.cn/posts/firefly-layout-system/)**
>
...
> 📚 **詳細配置文檔**: 查看 [Firefly使用文檔](https://docs-rainzt.cn/) 獲取完整的配置指南
...
- 提醒塊（Admonitions） - 支援 GitHub, Obsidian, VitePress 三種風格主題配置 ([預覽和用法](http://rainzt.cn/posts/markdown-extended/))
- GitHub 儲存庫卡片 ([預覽和用法](http://rainzt.cn/posts/markdown-extended/))
- 基於 Expressive Code 的增強程式碼區塊 ([預覽](http://rainzt.cn/posts/code-examples/) / [文檔](https://expressive-code.com/))
## 🧞 指令
