...
🚀 クイックガイド：
[**🖥️ライブデモ**](http://rainzt.cn/) /
[**📝ドキュメント**](https://docs-rainzt.cn/) /
...
>
>**レイアウト設定とデモの詳細については、[Firefly レイアウトシステム詳解](http://rainzt.cn/posts/firefly-layout-system/)をご覧ください**
>
...
> 📚 **詳細な設定ドキュメント**：[Fireflyドキュメント](https://docs-rainzt.cn/)で完全な設定ガイドを確認してください
...
- Admonitions（予告ブロック） - GitHub、Obsidian、VitePress、Docusaurusの4つのテーマ設定をサポート ([プレビューと使用方法](http://rainzt.cn/posts/markdown-extended/))
- GitHubリポジトリカード ([プレビューと使用方法](http://rainzt.cn/posts/markdown-extended/))
- Expressive Codeベースの強化コードブロック ([プレビュー](http://rainzt.cn/posts/code-examples/) / [ドキュメント](https://expressive-code.com/))
